...
from myapp.models import Staff,Staff_Notification,Staff_leave,Staff_Feedback,Subject,Session_Year,Student,Attendance,Attendance_Report,StudentResult
...
def STAFF_SAVE_RESULT(request):
    if request.method == "POST":
        ...
        if check_exists:
            ...
            result.save()
            messages.success(request,'Result has been successfully Updated')
            ...
            result.save()
            messages.success(request,'Result has been successfully Added')
            return redirect('staff_add_result')
